        ...
        (function() {
          ...
          };
          {
            ...
            var warnHyphenatedStyleName = function(name2) {
              ...
              error2("Unsupported style property %s. Did you mean %s?", name2, camelize2(name2.replace(msPattern$1, "ms-")));
            };
...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // ../../../../../node_modules/react-shadow-dom-retarget-events/index.js
  var require_react_shadow_dom_retarget_events = __commonJS({
    "../../../../../node_modules/react-shadow-dom-retarget-events/index.js"(exports, module) {
      var reactEvents = [
        "onAbort",
        "onAnimationCancel",
        "onAnimationEnd",
      ...
      module.exports = function retargetEvents2(shadowRoot) {
  ...
  var import_react_shadow_dom_retarget_events = __toESM(require_react_shadow_dom_retarget_events());
  function inject() {
    if (window.HTMLElement && window.HTMLElement._babelES5Adapter || window.Reflect === void 0 || window.customElements === void 0 || window.customElements.hasOwnProperty("polyfillWrapFlushCallback")) {
      return;
    }
    const a = HTMLElement;
  ...
  function defineElement$1(elSpec, elName, events) {
    ...
    observers[name$1] = observer;
    window.addEventListener("DOMContentLoaded", () => {
      const nodes = document.getElementsByTagName(name$1);
      each(nodes, (node) => checkForMount(node, name$1, events));
    });
  }
  ...
  function update(elSpec, mountPoint, props, element) {
    ...
    const reactElement = (0, import_react.createElement)(component, props);
    (0, import_react_dom.render)(reactElement, mountPoint);
    if (element) {
      (0, import_react_shadow_dom_retarget_events.default)(element.shadowRoot);
    }
  }
  function unmount(elSpec, mountPoint) {
    (0, import_react_dom.unmountComponentAtNode)(mountPoint);
  }
  ...
  function define(components, defaults) {
    ...
    Object.keys(components).forEach((name$$1) => {
  ...
  // app/javascript/react/src/components/Movies.jsx
  var import_react3 = __toESM(require_react());

  // app/javascript/react/src/components/AllMovies.jsx
  var import_react2 = __toESM(require_react());
  var AllMovies = class extends import_react2.default.Component {
    constructor(props) {
      super(props);
      this.state = {
        movies: []
    ...
    componentDidMount() {
      var API_URL = "http://movie-servi-1ucfqcznxsea2-329984211.us-east-1.elb.amazonaws.com";
      fetch(`${API_URL}/api/movies`).then((response) => {
    ...
    render() {
      return /* @__PURE__ */ import_react2.default.createElement("div", null, /* @__PURE__ */ import_react2.default.createElement("h2", null, "To do: List of movies"));
    }
    render() {
      var movies = this.state.movies.map((movie) => {
        return /* @__PURE__ */ import_react2.default.createElement("div", {
          key: movie.id
        }, /* @__PURE__ */ import_react2.default.createElement("h1", null, movie.title), /* @__PURE__ */ import_react2.default.createElement("p", null, "Released: ", movie.year), /* @__PURE__ */ import_react2.default.createElement("p", null, "Genre: ", movie.genre));
      });
      return /* @__PURE__ */ import_react2.default.createElement("div", null, movies);
    }
  };
  var AllMovies_default = AllMovies;

  // app/javascript/react/src/components/Movies.jsx
  var Movies = class extends import_react3.default.Component {
    render() {
      return /* @__PURE__ */ import_react3.default.createElement("div", null, /* @__PURE__ */ import_react3.default.createElement(AllMovies_default, null));
    }
  };
  var Movies_default = Movies;

  // app/javascript/react/src/index.js
  define({ "movie-component": Movies_default });
